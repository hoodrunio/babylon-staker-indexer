...
export class GovernanceIndexerService {
    ...
    public async start() {
        ...
        // Start the periodic status update for active proposals
        this.startPeriodicStatusUpdate();
    }

    private startPeriodicStatusUpdate() {
    ...
    public stop() {
        if (this.statusUpdateInterval) {
            ...
            logger.info('[Governance] Stopped periodic proposal status update interval');
        }
